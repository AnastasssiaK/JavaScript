...
//
//     divMember.append(name, surname,age,info,photo);
//     document.body.appendChild(divMember);
//
//     divMember.style.border = '2px solid cornflowerblue';
//     divMember.style.margin ='10px 0';
//     divMember.style.padding = '20px';
//     divMember.style.background = 'Khaki';
// }
...
for (const course of coursesArray) {
    ...
    wrap.style.background = 'cornflowerblue';
    wrap.style.padding = '20px';
    duration.style.display= 'flex';
    duration.style.justifyContent = 'space-evenly';
