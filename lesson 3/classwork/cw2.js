...
for (let i = 0; i < simpsons.length; i++) {
    document.write(`<div class="temp1">${simpsons[i].name} - ${simpsons[i].surname} - ${simpsons[i].age} - ${simpsons[i].info} - <img src="${simpsons[i].photo}" alt="simpsons"></div>`);
}

for (let i = 0; i < simpsons.length; i++) {
    document.write(`<div class="temp2">
